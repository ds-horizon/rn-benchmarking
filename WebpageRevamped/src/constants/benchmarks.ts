...
export const BENCHMARKS: BenchmarkItem[] = [
  // Available Benchmarks (shown first)
  {
    ...
    benchmarkUrl: 'https://ds-horizon.github.io/react-navigation-benchmark/',
    repoUrl: 'https://github.com/ds-horizon/react-navigation-benchmark',
    icon: '🧭',
    category: 'Navigation',
    type: 'multiple',
    libraries: [
  ...
  },
  {
    ...
    benchmarkUrl: 'https://ds-horizon.github.io/rn-tabs-benchmarks/',
    repoUrl: 'https://github.com/ds-horizon/rn-tabs-benchmarks',
    icon: '📱',
    category: 'Navigation',
    type: 'multiple',
    libraries: [
  ...
  },
  {
    ...
    benchmarkUrl: 'https://ds-horizon.github.io/GorhomBottomSheetBenchmark/',
    repoUrl: 'https://github.com/ds-horizon/GorhomBottomSheetBenchmark',
    icon: '📊',
    category: 'Components',
    type: 'single',
    libraries: [
  ...
  },
  {
    ...
    benchmarkUrl: 'https://ds-horizon.github.io/rn-webview-benchmark/',
    repoUrl: 'https://github.com/ds-horizon/rn-webview-benchmark',
    icon: '🌐',
    category: 'WebView',
    type: 'single',
    libraries: [
